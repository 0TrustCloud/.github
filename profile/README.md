...
* **0trust.services (Data Plane)**: A distributed mesh client deployed as an edge proxy or sidecar daemon.
...
* **identity_provider**: Manages WebAuthn handshakes and live tail telemetry over WebSocket streams.
